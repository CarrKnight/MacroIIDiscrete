...
public class PIDTargeter implements WorkforceTargeter, Steppable {
     ...
     */
    public PIDTargeter(HumanResources hr, PlantControl control,
                       float proportionalGain, float integrativeGain, float derivativeGain, float controlSpeed){
    ...
    public void step(SimState simState) {
        ...
        pid.adjust(workerTarget, hr.getPlant().workerSize(), active, hr.getPlant().getModel(), this);
