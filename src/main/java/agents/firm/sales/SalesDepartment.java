...
import agents.firm.sales.prediction.LearningFixedElasticitySalesPredictor;
...
public abstract class  SalesDepartment  implements Department {
    ...
    public static Class<? extends  SalesPredictor> defaultPredictorStrategy = LearningFixedElasticitySalesPredictor.class;
