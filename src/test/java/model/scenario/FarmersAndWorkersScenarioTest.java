...
public class FarmersAndWorkersScenarioTest {
    ...
    public void forcedCompetitiveRun200People() throws Exception {
        ...
        for(int j=0; j< 5; j++) {
            ...
            System.out.println("Agricultural Production: " + agriculturalProduction.getMean() + ", Manufacturing Production: "
                    + manufacturingProduction.getMean() + ", manufacturing price: " + manufacturingPrice.getMean() + ", cash: " + scenario1.getProducers().get(0).hasHowMany(FarmersAndWorkersScenario.AGRICULTURE));
    ...
    public void forcedCompetitiveRun50People() throws Exception {
        ...
        for(int j=0; j< 5; j++) {
            ...
            scenario1.setLinearProductionPerWorker(10);
            scenario1.setNumberOfAgents(50);
      ...
      /*      System.out.println(macroII.schedule.getTime());
            ...
            System.out.println("M Ask:" + scenario1.getProducers().get(0).getSalesDepartment(scenario1.MANUFACTURED).getLastAskedPrice() +
                    ", M Traded: " + market.getYesterdayVolume() + ", M inventory: " + scenario1.getProducers().get(0).hasHowMany(scenario1.MANUFACTURED) +
                    ", cash: " + scenario1.getProducers().get(0).hasHowMany(FarmersAndWorkersScenario.AGRICULTURE));
            System.out.println("==========================================================================================================");
            */
                System.out.println("M produced: " + scenario1.countManufacturedProduction() +", cash: " + scenario1.getProducers().get(0).hasHowMany(FarmersAndWorkersScenario.AGRICULTURE));
            ...
            Assert.assertEquals(280, manufacturingProduction.getMean(), 15); //5% error allowed
            Assert.assertEquals(869, agriculturalProduction.getMean(), 44);
            Assert.assertEquals(2.7, manufacturingPrice.getMean(), 0.5);
