...
public class RecursiveLeastMeansFilterTest {
    ...
    public void testUnweightedRegression() throws Exception {
        ...
        RecursiveLinearRegression regression = new RecursiveLeastMeansFilter(2,.1);
    ...
    @Test
    public void testOrdersOfMagnitude() throws Exception {
        MersenneTwisterFast random = new MersenneTwisterFast();
        RecursiveLinearRegression regression = new RecursiveLeastMeansFilter(2,1);

        int randomIntercept = 500;
        int randomSlope =  - 3;
        ...
        Assert.assertEquals(-3, regression.getBeta()[1], .1d);
        Assert.assertEquals(200,regression.getBeta()[0],1d);
