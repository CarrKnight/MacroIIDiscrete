 ...
 * @see
 */
public class TrueRandomSchedulerTest
{
    ...
    public void isRandomTest()
    {
        ...
        for(int i =0 ; i <100; i++)
        {
            ...
            TrueRandomScheduler scheduler = new TrueRandomScheduler(1,new MersenneTwisterFast(i));
        ...
        System.out.println(countHowManyTimes0IsWritten);
    ...
    public void priorityTest()
    {
        ...
        TrueRandomScheduler scheduler = new TrueRandomScheduler(1,new MersenneTwisterFast(System.currentTimeMillis()));
    ...
    public void priorityTomorrowTest()
    {
        ...
        final TrueRandomScheduler scheduler = new TrueRandomScheduler(1,new MersenneTwisterFast(System.currentTimeMillis()));
