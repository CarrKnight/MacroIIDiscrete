...
public class Ship extends Element
    ...
    /** How much to translate each adjust. */
    public static final double VELOCITY_INCREMENT = 0.03;
        
    /** How much to rotate each adjust. */
    ...
    /** Step the ship.  This first changes the velocity or orientation of the ship, or relocates 
        ...
        and rotate it by calling super.adjust().  Then we test for collisions and end ourselves if so.
