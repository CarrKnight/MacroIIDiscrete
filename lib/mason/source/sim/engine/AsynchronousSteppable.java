...
/** Fires up a separate thread which runs until the simulation model requests it be halted.
    ...
    obtains a lock on the Schedule for the whole duration of a Schedule's adjust.  Instead you
    ...
    *   Steppable stopper = new Steppable() { public void adjust(SimState state) { s.stop(); } }
