...
/** 
    ...
    schedule.scheduleRepeating( ... , new Steppable() { public void adjust(SimState state) { myObject.foo() } }, ...);
    schedule.scheduleRepeating( ... , new Steppable() { public void adjust(SimState state) { myObject.foo() } }, ...);
    schedule.schedule( ... , new Steppable() { public void adjust(SimState state) { myJFrame.show() } }, ...);
    schedule.scheduleRepeating( ... , new Steppable() { public void adjust(SimState state) { myObject.baz(state) } }, ...);
    schedule.scheduleRepeating( ... , new Steppable() { public void adjust(SimState state) { myObject.quux(state) } }, ...);
    </tt></pre>
*/
