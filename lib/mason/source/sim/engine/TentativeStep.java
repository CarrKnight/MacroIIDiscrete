...
/**
   ...
   schedule the TentativeStep on the Schedule.  When you want to prevent the agent's adjust() method from
   ...
   scheduled, and so at some point the Schedule's time adjust will advance to that point even if the
