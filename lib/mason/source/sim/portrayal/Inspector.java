...
public abstract class Inspector extends JPanel
    ...
    /** Set to true (default) if the inspector should be updated every time adjust.  Else set to false. */
    public void setVolatile(boolean val) {_volatile = val;}
        
    /** Returns true (default) if the inspector should be updated every time adjust.  Else returns false. */
