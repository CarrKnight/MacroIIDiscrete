...
public class ChangeLookupMAMarketTest {
    ...
    public void changeLookup()
    {
        ...
        Assert.assertEquals(changeLookupMAMarket.getChange(),0f,.0001f); //invalid
        ...
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),1f,.0001f); //100%!
        ...
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.45666f,.0001f);

        when(market.getLastPrice()).thenReturn(7l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.29f,.0001f);

        when(market.getLastPrice()).thenReturn(8l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.2185714286f,.0001f);

        when(market.getLastPrice()).thenReturn(9l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.1769047619f,.0001f);

        when(market.getLastPrice()).thenReturn(10l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.1491269841f,.0001f);

        when(market.getLastPrice()).thenReturn(11l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.1291269841f,.0001f);

        when(market.getLastPrice()).thenReturn(12l);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0.113975469f,.0001f);
    ...
    public void priceIsAlwaysStuckAt0()
    {
        ...
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0f,.0001f);
        ...
        changeLookupMAMarket.step(macroII);
        changeLookupMAMarket.step(macroII);
        Assert.assertEquals(changeLookupMAMarket.getChange(),0,.0001f);
