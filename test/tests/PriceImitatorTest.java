...
public class PriceImitatorTest {
    ...
    public void imitationTest() throws Exception {
        ...
        Assert.assertEquals(strategy.price(good), 20);  //now just copy the opponent!
        ...
        Assert.assertEquals(strategy.price(good), 20); //now copy
        ...
        Assert.assertEquals(strategy.price(good), 21); //now markup should be 100% and lastValue is 20
