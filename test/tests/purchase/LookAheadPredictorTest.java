...
public class LookAheadPredictorTest {
    ...
    public void defaultTest() throws Exception {
        ...
        Assert.assertEquals(predictor.predictPurchasePrice(dept), 10);
        ...
        Assert.assertEquals(predictor.predictPurchasePrice(dept),1);
    ...
    public void properTest() throws Exception {
        ...
        PurchasesDepartment dept = mock(PurchasesDepartment.class); when(dept.getMarket()).thenReturn(market);
        Assert.assertEquals(predictor.predictPurchasePrice(dept),-1); //there is no price!
