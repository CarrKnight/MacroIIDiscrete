...
public class PurchasesWeeklyPIDTest {
    ...
    public void simpleStubTestFromBelow(){
        ...
        Assert.assertEquals(control.getWeeklyNeeds(),0f,0.0001f);
    ...
    public void fullDressRehearsal() throws NoSuchFieldException, IllegalAccessException {
        ...
        Assert.assertEquals(control.getWeeklyNeeds(),6*model.getWeekLength()/25f,.01);
        control.start();
    ...
    //    Assert.assertEquals(f.hasHowMany(GoodType.GENERIC),25); //has 6 but I just consumed 2
