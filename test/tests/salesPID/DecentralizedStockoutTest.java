...
//        market.registerSeller(owner);
    ...
    public void simpleStockoutMockTest() throws IllegalAccessException, NoSuchFieldException {
        ...
        SalesDepartment dept = SalesDepartment.newSalesDepartment(firm,market,SimpleBuyerSearch.class,SimpleSellerSearch.class,SimpleFlowSellerPID.class,null);
    ...
    @Test public void simpleDecentralizedScenario()
    {
        ...
        for(int i=0; i<10; i++)
        {
            ...
            Assert.assertTrue("finalPrice: " + finalPrice,finalPrice >= 51 && finalPrice <= 60);
        ...
        for(int i=0; i<10; i++)
        {
            ...
            long finalPrice = sellerScenario1.getMarkets().get(GoodType.GENERIC).getLastPrice();
            Assert.assertTrue("finalPrice: " + finalPrice,finalPrice >= 151 && finalPrice <= 160);
