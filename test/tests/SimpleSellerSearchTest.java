...
public class SimpleSellerSearchTest {
    ...
    public void scenario1(){
        ...
        Assert.assertTrue(sample.contains(seller1)); //TODO
        Assert.assertTrue(sample.contains(seller2));
        Assert.assertTrue(sample.contains(seller3));
        Assert.assertTrue(sample.contains(seller4));
        Assert.assertTrue(sample.contains(seller5));

        EconomicAgent bestSeller = toTest.getBestInSampleSeller();
        Assert.assertEquals(seller1,bestSeller);
        Assert.assertEquals(10,bestSeller.askedForASaleQuote(f, GoodType.GENERIC).getPriceQuoted());

        seller5.setSaleQuote(5l);

        bestSeller = toTest.getBestInSampleSeller();
        Assert.assertEquals(seller5,bestSeller);
        Assert.assertEquals(5,bestSeller.askedForASaleQuote(f, GoodType.GENERIC).getPriceQuoted());
    ...
    public void scenario2(){
        ...
        EconomicAgent bestSeller = toTest.getBestInSampleSeller();
        Assert.assertTrue(bestSeller == seller3 || bestSeller == seller4);
    ...
    public void scenario3(){
        ...
        EconomicAgent bestSeller = toTest.getBestInSampleSeller();
        Assert.assertTrue(bestSeller == seller1);
    ...
    public void scenario4(){
        ...
        EconomicAgent bestSeller = toTest.getBestInSampleSeller();
        Assert.assertTrue(bestSeller ==null);
