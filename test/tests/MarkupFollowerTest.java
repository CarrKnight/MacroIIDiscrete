...
public class MarkupFollowerTest {
 ...
 //       dept.getFirm().getSalesDepartments().put(GoodType.GENERIC,dept);
    ...
    public void imitationTest() throws Exception {
        ...
        Assert.assertEquals(strategyAsk.price(good), 40); //now markup should be 100% and lastValue is 20

        good.setLastValidPrice(100l);
        Assert.assertEquals(strategyAsk.price(good), 200); //now markup should be 100% and lastValue is 20
