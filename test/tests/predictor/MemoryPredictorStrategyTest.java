...
public class MemoryPredictorStrategyTest {
    ...
    public void scenario1() throws Exception {
        ...
        Assert.assertEquals(-1, strategy.predictSalePrice(department, 200)); //fails because there is nothing memory
    ...
    public void scenario2() throws Exception {
        ...
        Assert.assertEquals(-1,strategy.predictSalePrice(department,200)); //copy last closing price
        Assert.assertEquals(200,department.predictSalePrice(200)); //overridden by looking at the order book.
    ...
    public void scenario3() throws Exception {
        ...
        Assert.assertEquals(-1,strategy.predictSalePrice(department,200)); //copy last closing price
        Assert.assertEquals(-1,department.predictSalePrice(200)); //not overriden this time!
    ...
    public void scenario5() throws Exception {
        ...
        Assert.assertEquals(250,strategy.predictSalePrice(department,200)); //copy YOUR last closing price
        Assert.assertEquals(200,department.predictSalePrice(200)); //overridden by looking at the order book.
