...
public class PricingPredictorStrategyTest {
    ...
    public void scenario1() throws Exception {
        ...
        Assert.assertEquals(240, strategy.predictSalePrice(department, 200)); //markup 20% (since you haven't stepped and seen the competition)
        pricing.step(model);
        Assert.assertEquals(297, strategy.predictSalePrice(department, 200)); //undercut by 1%
    ...
    public void scenario2() throws Exception {
        ...
        Assert.assertEquals(240, strategy.predictSalePrice(department, 200)); //markup 20% (since you haven't stepped and seen the competition)
        pricing.step(model);
        Assert.assertEquals(297,strategy.predictSalePrice(department,200)); //undercute by 1%
        Assert.assertEquals(200,department.predictSalePrice(200)); //overridden by looking at the order book.
    ...
    public void scenario3() throws Exception {
        ...
        Assert.assertEquals(240, strategy.predictSalePrice(department, 200)); //markup 20% (since you haven't stepped and seen the competition)
        pricing.step(model);
        Assert.assertEquals(297,strategy.predictSalePrice(department,200)); //undercut 1%
        Assert.assertEquals(297,department.predictSalePrice(200)); //not overriden this time!
    ...
    public void scenario4() throws Exception {
        ...
        department.setAskPricingStrategy(pricing) ;
        Assert.assertEquals(240, strategy.predictSalePrice(department, 200)); //markup 20% (since you haven't stepped and seen the competition)
        Assert.assertEquals(240,department.predictSalePrice(200)); //can't find anything on the order book, better ask the predict strategy
    ...
    public void scenario5() throws Exception {
        ...
        Assert.assertEquals(240, strategy.predictSalePrice(department, 200)); //markup 20% (since you haven't stepped and seen the competition)
        pricing.step(model);
        Assert.assertEquals(297,strategy.predictSalePrice(department,200)); //copy the last closing price (which is our closing price anyway)
        Assert.assertEquals(200,department.predictSalePrice(200)); //overridden by looking at the order book.
